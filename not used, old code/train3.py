...
if __name__ == '__main__':
    ...
    model.summary()
    # Train new model
    model.fit(trainingDS, epochs = 40, validation_data = validateDS, callbacks = [checkpointCallback])
    # Save model after training
    model.save(modelFolder + "/done_v3.keras")
